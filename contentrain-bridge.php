...
define( 'CONTENTRAIN_BRIDGE_VERSION', '0.3.1' );
define( 'CONTENTRAIN_BRIDGE_FILE', __FILE__ );

foreach ( array( 'policy', 'files', 'exporter', 'source', 'inventory', 'delta', 'seo-render', 'seo', 'redirects', 'routing', 'scanner', 'text', 'coverage', 'integrations', 'acf', 'models', 'validator', 'rawir', 'jobs', 'github', 'remote', 'admin' ) as $contentrain_bridge_class ) {
