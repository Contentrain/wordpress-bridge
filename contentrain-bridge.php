...
foreach ( array( 'policy', 'files', 'exporter', 'source', 'inventory', 'delta', 'seo', 'redirects', 'routing', 'scanner', 'text', 'acf', 'models', 'validator', 'jobs', 'github', 'admin' ) as $contentrain_bridge_class ) {
