...
final class Jobs {
	...
	public static function save( $job ) {
		...
		// Internal state, not a delivered file: compact, and without Policy's canonical sort, whose
		// recursive copies of a large site's key maps were what exhausted memory (BR-24).
